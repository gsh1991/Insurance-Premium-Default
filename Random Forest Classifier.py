# -*- coding: utf-8 -*-
"""
Created on Sun Mar 19 20:31:47 2023
...
data.drop(['NumberofPremiumspaidtilldateinmonths', 'PolicyTerminyears','Sumassured','YearlyPremium','latepayment0to3months','Nominee','Dependents','PolicyholderID','PolicyholderName','PlanName'], axis = 1, inplace = True)
data.dtypes
data.columns
data.shape


# Model Building using RandomForestClassifier algorithm
