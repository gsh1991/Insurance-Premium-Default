...
# Model Building using Gradient Boosting algorithm
...
gbc = GradientBoostingClassifier(loss='deviance', n_estimators=100, learning_rate=0.1, max_depth=3, random_state=42)
# Train the Gradient Boosting model on training data
